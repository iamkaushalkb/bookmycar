...
<title>BookMyCar.com | Vehicle Details</title>
<!--Bootstrap -->
...
<div id="carousel" class="owl-carousel">
	<div class="item">
  <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" width="900" height="650">
	</div>
	<div class="item">
  <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" class="img-responsive" alt="image" width="900" height="650">
	</div>
	<div class="item">
  <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" width="900" height="650">
	</div>
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <div class="form-group">
                ...
                <div class="form-group">
              <button id="payment-button" class="btn">Pay Now</button>
              </div>
                </div>
              </div>
              <?php } else { ?>
